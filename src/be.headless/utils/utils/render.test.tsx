...
import { createRef, ElementType, Fragment, Ref } from 'react'
...
describe('Default functionality', () => {
    ...
    it('should be possible to add a ref with a different name', () => {
        ...
        function OtherDummy<TTag extends ElementType = 'div'>(
            props: Props<TTag>,
        ) {
            return (
                <div data-testid="wrapper">
...
describe('Features.Static', () => {
    ...
    function Dummy<TTag extends ElementType = 'div'>(
        props: Expand<
            Props<TTag> & PropsForFeatures<typeof EnabledFeatures>
        > & { show: boolean },
    ) {
        let { show, ...rest } = props
        return (
