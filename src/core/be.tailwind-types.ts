 ...
 */
export type BeTVisibilityDisplay =
    | 'hidden'
    | 'block'
    | 'inline-block'
    | 'inline'
...
export type BeTTransformOrigin =
    | 'center'
    | 'top'
    | 'right'
    | 'bottom'
...
export type BeTVisibility = 'visible' | 'invisible' | 'collapse'
...
export type BeTBoxShadow =
    ...
    | 'none'
    | 'shadow'
export type BeTBoxShadowColor = BeTColor
...
export type BeTBorderAxis = 't' | 'b' | 'l' | 'r'
export type BeTAxisBorderWidth = `${BeTBorderAxis}-${BeTBorderSizeInterval}`
...
export type BeTDivideSizeInterval =
    | BeTBorderSizeInterval
    | `x-${BeTBorderSizeInterval}`
    | `y-${BeTBorderSizeInterval}`
export type BeTOutlineSizeInterval = '0' | '1' | '2' | '4' | '8'
...
export type BeTAxisOutline = {
    x?: 'outline-x' | 'outline-x-reverse' | BeTDivideSizeInterval | undefined
    y?: 'outlinee-y' | 'outline-y-reverse' | BeTDivideSizeInterval | undefined
}
...
export type BeTOutlineColor = BeTColor
export type BeTOutlineStyle = BeTLineStyle
export type BeTOutlineWidth = BeTOutlineSizeInterval | 'none'
...
export interface BeTOutline {
    width?: BeTOutlineWidth | undefined
    color?: BeTOutlineColor | undefined
    style?: BeTOutlineStyle | undefined
}
